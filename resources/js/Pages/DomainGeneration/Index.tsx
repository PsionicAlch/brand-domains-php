                ...
                <div className="flex-1 flex flex-col justify-center items-center">
                    <div className="w-full">
                        ...
                        <ol className="list-decimal text-xs text-neutral-500 font-light mb-5 px-5 md:text-base">
                            ...
                            <li>What should your domain end in? (<a href={`${route('howto')}#ValidDomainExtensions`} className="text-neutral-950 hover:underline" target="_blank">List of valid domain extensions</a>)</li>
